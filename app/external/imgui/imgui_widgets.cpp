...
namespace ImStb
{
                                       ...
                                       int line_start_idx)
    {
        ...
        const ImVec2 size = InputTextCalcTextSizeW(
            obj->Ctx, text + line_start_idx, text + obj->CurLenW,
    ...
    {
        // When ImGuiInputTextFlags_Password is set, we don't want actions such
        // as CTRL+Arrow to leak the fact that underlying data are blanks or
        // separators.
...
#define STB_TEXTEDIT_MOVEWORDRIGHT STB_TEXTEDIT_MOVEWORDRIGHT_IMPL
    ...
    static void STB_TEXTEDIT_DELETECHARS(ImGuiInputTextState *obj, int pos,
                                         int n)
    {
